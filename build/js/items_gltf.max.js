$(document).ready(function() {
   ...
   /* {
        ...
        "name": "책장",
        "image": "models/thumbnails_new/bookcaseClosedWide.jpg",        //남겨놔야하는 것 책장
        "model": "models/gltf/bookcaseClosedWide.glb",
        "type": "9",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%82%98%EB%AC%B4%20%EC%B1%85%EC%9E%A5&frm=NVSHATC&prevQuery=%EC%B1%85%EC%9E%A5",
    },/* {
        "name": "Bookcaseopen",
    ...
    // }, 
    {
        ...
        "name": "베란다창",
        "image": "models/thumbnails_new/doorwayOpen.jpg",        //남겨놔야하는 문지방
        "model": "models/gltf/doorwayOpen.glb",
        "type": "7", // 3->7
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%B2%A0%EB%9E%80%EB%8B%A4%EC%B0%BD&frm=NVSHATC&prevQuery=%EB%AC%B8%ED%8B%80",
    }, {
        "name": "건조기",
        "image": "models/thumbnails_new/dryer.jpg",
        "model": "models/gltf/dryer.glb",           //남겨나와하는 세탁기
        "type": "2",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?where=all&frm=NVSCTAB&query=%EA%B1%B4%EC%A1%B0%EA%B8%B0",
    }, /*{
        "name": "Floorcorner",
        ...
        "model": "models/gltf/shower.glb",                  //샤워부스
        "type": "2", // 9->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%83%A4%EC%9B%8C%20%EB%B6%80%EC%8A%A4&frm=NVSHATC&prevQuery=%EB%93%9C%EB%9F%BC%20%EC%84%B8%ED%83%81%EA%B8%B0",
    }, {
        "name": "라운드형 샤워부스",
        "image": "models/thumbnails_new/showerRound.jpg",
        "model": "models/gltf/showerRound.glb",
        "type": "2", // 9->2                                            //구석형 샤워부스
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%9D%BC%EC%9A%B4%EB%93%9C%20%EC%83%A4%EC%9B%8C%20%EB%B6%80%EC%8A%A4&frm=NVSHATC&prevQuery=%EB%9D%BC%EC%9A%B4%EB%93%9C%EC%83%A4%EC%9B%8C%20%EB%B6%80%EC%8A%A4",
    },/* {
        "name": "Sidetable",
    ...
    // }, 
    {
        ...
        "name": "베란다창2",
        "image": "models/thumbnails_new/wallDoorway.jpg",
        "model": "models/gltf/wallDoorway.glb",                      //남겨놔야하는 문틀2
        "type": "7", // 3->7
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%B2%A0%EB%9E%80%EB%8B%A4%EC%B0%BD&frm=NVSHATC&prevQuery=%EB%AC%B8%ED%8B%80",
    }, /* {
        ...
        "name": "여닫이창문",
        "image": "models/thumbnails_new/wallWindow.png",     //남겨놔야하는 여닫이창문
        "model": "models/gltf/wallWindow.glb",
        "type": "3",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%97%AC%EB%8B%AB%EC%9D%B4%EC%B0%BD&frm=NVSHATC&prevQuery=%EC%97%AC%EB%8B%AB%EC%9D%B4%ED%98%95%20%EC%B0%BD%EB%AC%B8",
    }, {
        "name": "오르내리창문2",
        "image": "models/thumbnails_new/wallWindowSlide.jpg",      //남겨놔야하는 오르내리창문
        "model": "models/gltf/wallWindowSlide.glb",
        "type": "3",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%98%A4%EB%A5%B4%EB%82%B4%EB%A6%AC%EC%B0%BD&frm=NVSHATC&prevQuery=%EC%98%A4%EB%A5%B4%EB%82%B4%EB%A6%BC%EC%B0%BD",
    }, /* {
        "name": "Washer",
    ...
    }, 
    {
        ...
        "name": "화장실 거울",
        "image": "models/thumbnails_new/bathroomMirror.jpg",
        "model": "models/gltf/bathroomMirror.glb",                    //남겨놔야하는 화장실 유리
        "type": "2",
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%ED%99%94%EC%9E%A5%EC%8B%A4%20%EA%B1%B0%EC%9A%B8&frm=NVSHATC&prevQuery=%ED%99%94%EC%9E%A5%EC%8B%A4%20%EC%9C%A0%EB%A6%AC",
    }, /* {
        "name": "Bathroomsink",
    ...
    */
    {
        "name": "욕조1",
        "image": "models/thumbnails_new/bathtub.jpg",         //남겨놔야하는 욕조
        "model": "models/gltf/bathtub.glb",
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%9A%95%EC%A1%B0&frm=NVSHATC&prevQuery=%ED%99%94%EC%9E%A5%EC%8B%A4%20%EC%9C%A0%EB%A6%AC",
    },  {
        "name": "소파",
        ...
        "type": "1", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%86%8C%ED%8C%8C&frm=NVSHATC&prevQuery=%EC%9A%95%EC%A1%B0",
    },  {
        "name": "컴퓨터책상",
        "image": "models/thumbnails/office_desk1.jpg",
        "model": "models/gltf/office_desk1.glb",                  //내가 추가한 것들 사무용 책상
        "type": "1", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%BB%B4%ED%93%A8%ED%84%B0%EC%B1%85%EC%83%81&frm=NVSHATC&prevQuery=%EC%86%8C%ED%8C%8C",
    },  {
        "name": "킹사이즈 침대",
        "image": "models/thumbnails/bed1.jpg",
        "model": "models/gltf/bed1.glb",                  //내가 추가한 것들 침대
        "type": "1", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%ED%82%B9%EC%82%AC%EC%9D%B4%EC%A6%88%20%EC%B9%A8%EB%8C%80&frm=NVSHATC&prevQuery=%ED%82%B9%20%EC%B9%A8%EB%8C%80",
    },  {
        "name": "벽걸이 선반",
        "image": "models/thumbnails/wall_stand.jpg",
        "model": "models/gltf/wall_stand.glb",                  //내가 추가한 것들 선반
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%B2%BD%EA%B1%B8%EC%9D%B4%20%EC%84%A0%EB%B0%98&frm=NVSHATC&prevQuery=%EC%84%A0%EB%B0%98",
    },  {
        "name": "장농",
        "image": "models/thumbnails/wardrobe.jpg",
        "model": "models/gltf/wardrobe.glb",                  //내가 추가한 것들 장농
        "type": "1", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%9E%A5%EB%86%8D&frm=NVSHATC&prevQuery=%EB%B2%BD%EA%B1%B8%EC%9D%B4%20%EC%84%A0%EB%B0%98",    
    },  {
        "name": "에어컨",
        ...
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%B2%BD%EA%B1%B8%EC%9D%B4%ED%98%95%20%EC%97%90%EC%96%B4%EC%BB%A8&frm=NVSHATC&prevQuery=%EC%9E%A5%EB%86%8D",    
    },  {
        "name": "화초",
        ...
        "type": "8", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%ED%99%94%EC%B4%88&frm=NVSHATC&prevQuery=%EB%B2%BD%EA%B1%B8%EC%9D%B4%ED%98%95%20%EC%97%90%EC%96%B4%EC%BB%A8",    
    },  {
        "name": "양변기",
        "image": "models/thumbnails/toilet1.jpg",
        "model": "models/gltf/toilet1.glb",                  //내가 추가한 것들 변기
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%96%91%EB%B3%80%EA%B8%B0&frm=NVSHATC&prevQuery=%ED%99%94%EC%B4%88",    
    },  {
        "name": "욕조2",
        ...
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%8B%B1%ED%81%AC%EB%8C%80&frm=NVSHATC&prevQuery=%ED%99%94%EC%9E%A5%EC%8B%A4%20%EC%84%B8%EB%A9%B4%EB%8C%80",    
    },  {
        "name": "화장실 세면대",
        "image": "models/thumbnails/sink2.jpg",
        "model": "models/gltf/sink2.glb",                  //내가 추가한 것들 화장실 세면대
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%ED%99%94%EC%9E%A5%EC%8B%A4%20%EC%84%B8%EB%A9%B4%EB%8C%80&frm=NVSHATC&prevQuery=%EC%96%91%EB%B3%80%EA%B8%B0",    
    },  {
        "name": "디자인 냉장고1",
        ...
        "type": "2", // 1->2
        "format": "gltf" ,
        "link" : "https://search.shopping.naver.com/search/all?query=%EB%94%94%EC%9E%90%EC%9D%B8%20%EB%83%89%EC%9E%A5%EA%B3%A0&frm=NVSHATC&prevQuery=%EC%9D%BC%EB%B0%98%ED%98%95%20%EB%83%89%EC%9E%A5%EA%B3%A0",   
    },  {
        "name": "일반형 냉장고2",
        ...
        "type": "2", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%9D%BC%EB%B0%98%ED%98%95%20%EB%83%89%EC%9E%A5%EA%B3%A0&frm=NVSHATC&prevQuery=%EB%83%89%EC%9E%A5%EA%B3%A0",   

    },  {
        "name": "여닫이 창문2",
        "image": "models/thumbnails/window.png",
        "model": "models/gltf/window.glb",                  //내가 추가한 것들 창문
        "type": "3", // 1->2
        "format": "gltf",
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%97%AC%EB%8B%AB%EC%9D%B4%EC%B0%BD&frm=NVSHATC&prevQuery=%EC%97%AC%EB%8B%AB%EC%9D%B4%20%EC%B0%BD"  
    },  {
        "name": "주방 싱크대",
        "image": "models/thumbnails/kitchen.jpg",
        "model": "models/gltf/kitchen.glb",                  //내가 추가한 것들 
        "type": "2", // 1->2
        "format": "gltf" ,
        "link" : "https://search.shopping.naver.com/search/all?query=%EC%A3%BC%EB%B0%A9%20%EC%8B%B1%ED%81%AC%EB%8C%80&cat_id=&frm=NVSHATC"  
  
    },  {
        "name": "주방 싱크대 2",
        "image": "models/thumbnails/kitchen2.jpg",
        "model": "models/gltf/kitchen2.glb",                  //내가 추가한 것들 창문
        "type": "2", // 1->2
        "format": "gltf",
        "link" : ""
    }
